...
import { BookOpen, GraduationCap, Mail, User as UserIcon, LogOut, ArrowRight, ExternalLink, Trash2 } from "lucide-react";
...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "View your student profile, academic standing, and enrolled courses." },
    ],
  }),
  component: Profile,
});
      ...
      <section className="bg-secondary/40 min-h-[80vh] flex items-center justify-center py-16">
        <div className="mx-auto max-w-md px-5 text-center">
          <div className="bg-card border border-border/80 rounded-2xl p-8 shadow-xl">
            ...
            <h1 className="mt-4 font-display text-2xl font-bold text-foreground">Sign in to view your profile</h1>
            <p className="mt-2 text-sm text-muted-foreground">
              Please log in or register a student account to view your enrollments, syllabus, and track progress.
            </p>
      ...
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          {userCourses.length > 0 && (
            <Link to="/courses" className="text-sm text-marigold hover:underline flex items-center gap-1">
        ...
        {userCourses.length === 0 ? (
          <div className="bg-card border border-border/80 rounded-2xl p-10 text-center shadow-md">
            ...
            <h3 className="mt-4 text-lg font-semibold text-foreground">Not Enrolled in Any Courses</h3>
            <p className="mt-2 text-sm text-muted-foreground max-w-md mx-auto">
              You haven't enrolled in any courses yet. QuickCatch offers free, faculty-curated curriculums.
            </p>
            <Button asChild className="mt-6 bg-marigold text-marigold-foreground hover:bg-marigold/90 font-semibold">
